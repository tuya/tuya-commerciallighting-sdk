...
public class AddDeviceTipActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mStatusLightTip.setText(R.string.thing_add_device_ez_info);
        initTipImageView();
        mStatusLightOption = (Button) findViewById(R.id.status_light_option);
        mStatusLightOption.setText(R.string.thing_add_device_ez_btn_info);
    ...
    private void initTipImageView() {
        ...
        mStatusLightAnimation.addFrame(ContextCompat.getDrawable(this, R.drawable.thing_adddevice_lighting), 250);
        mStatusLightAnimation.addFrame(ContextCompat.getDrawable(this, R.drawable.thing_adddevice_light), 250);
