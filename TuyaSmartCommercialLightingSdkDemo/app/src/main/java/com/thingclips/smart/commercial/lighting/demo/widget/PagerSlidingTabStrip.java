...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean tabSelectedTextBold = false;
    private int tabSelectedTextColor = tabTextColor;
    ...
    public boolean isSelectedBold() {
        return tabSelectedTextBold;
    }

    public void setSelectedBold(boolean selectedBold) {
        tabSelectedTextBold = selectedBold;
        updateTabStyles();
    }
